...
class AggregationOptions(QtWidgets.QWidget):
    ...
    def __init__(self, scrollable, orientation, parent=None):
        ...
        self.activeSelection.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        ...
        self.periodStart.calendarWidget().setHorizontalHeaderFormat(QtWidgets.QCalendarWidget.NoHorizontalHeader)
        #self.periodStart.calendarWidget().setNavigationBarVisible(False)
        self.periodStart.setMinimumDate(QtCore.QDate(1901, 10, 1))
        self.periodStart.setMaximumDate(QtCore.QDate(1902, 9, 30))
        self.periodStart.setDate(QtCore.QDate(1901, 10, 1))
        ...
        if scrollable:
            ...
            if orientation == 'vertical':
                ...
                layoutVertical.addItem(QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding))
                ...
                # layoutVertical.addItem(QtWidgets.QSpacerItem(20, 10, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Maximum))
                self.setLayout(layoutVertical)
