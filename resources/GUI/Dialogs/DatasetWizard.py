...
class DatasetWizard(QtWidgets.QWizard):
    ...
    def updateDataset(self, newID):
        ...
        if newID > self.metadataID:
            ...
            self.dataset['DatasetCompositeEquation'] = None
        ...
        if newID == -100:
            ...
            if selection == 0:
                self.dataset['DatasetDataloader'] = self.dataLoaderSelect.currentText()
            ...
            if selection == 3:
                self.dataset["DatasetDataloader"] = "COMPOSITE"
                ...
                try:
                    ...
                    self.dataset['DatasetCompositeEquation'] = 'C/-999/1.0/0'
