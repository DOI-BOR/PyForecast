...
class DatasetTab(QtWidgets.QWidget):
    ...
    def __init__(self, parent = None):
        ...
        self.selectedDatasetsWidget = DatasetList_HTML_Formatted.DatasetList_HTML_Formatted(datasetTable = self.datasetTable)
        ...
        self.searchResultsBox = DatasetList_HTML_Formatted.DatasetList_HTML_Formatted(datasetTable = self.datasetTable, buttonText = 'Add Dataset')
        layout_.addWidget(label)
        ...
        self.boxHucResultsBox = DatasetList_HTML_Formatted.DatasetList_HTML_Formatted(datasetTable = self.datasetTable, buttonText = 'Add Dataset')
        layout2 = QtWidgets.QHBoxLayout()
