...
class ModelList(QListView):
    ...
    def __init__(self, app=None):
        ...
        self.generate_forecast_action.setStatusTip(
            'Generate forecasts for using this model')
        self.open_action = QAction('Open model')
        self.open_action.setStatusTip(
            "Opens the forecast model in a new window for viewing model parameters")
